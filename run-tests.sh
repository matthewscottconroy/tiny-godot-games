...
SUITE_ABORT_RE='previously freed|Invalid access to property|Nonexistent function|Invalid type in function|Invalid index|Out of bounds|null instance|Division By Zero|Invalid assignment|Trying to assign value of type|Trying to assign an array of type|Invalid access of index'
